...
import { IType } from '../../interface/application.interface';
...
export class EditTypeComponent {
  ...
  saveData() {
    ...
    firstValueFrom(this.type ? this.applicationService.editType(rawValue) : this.applicationService.newType(rawValue)).then(_ => {
